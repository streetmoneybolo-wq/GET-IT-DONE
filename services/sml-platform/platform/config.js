...
function getConfig(env = process.env) {
  ...
  return Object.freeze({
    ...
    academyElevenLabsApiKey: String(env.ELEVENLABS_API_KEY || '').trim(),
    academyElevenLabsVoiceId: String(env.SML_ACADEMY_ELEVENLABS_VOICE_ID || '').trim(),
    academyElevenLabsModel: String(env.SML_ACADEMY_ELEVENLABS_MODEL || 'eleven_multilingual_v2').trim(),
