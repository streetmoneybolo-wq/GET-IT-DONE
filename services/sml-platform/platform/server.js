...
#academy-unlock{position:fixed;z-index:2147483647;right:18px;bottom:18px;margin:0;padding:12px 16px;border:2px solid #75f5bf;border-radius:10px;background:#00c47d;color:#042217;font-size:.85rem;box-shadow:0 10px 30px rgba(0,0,0,.55),0 0 20px rgba(0,196,125,.45)}body.academy-tools-open{overflow:hidden}body.academy-tools-open main{position:fixed;inset:0;z-index:2147483000;width:100vw;height:100vh;background:#070b10}body.academy-tools-open #academy-unlock{top:14px;right:14px;bottom:auto}
</style>
