...
(function () {
  ...
  /* no signal file yet (a group that never chirped) or it is unreachable: ask /chirps instead, at most every 15 s */
  function fallback() { if (++sigFails > 3 && Date.now() - fallbackAt > 15000) { fallbackAt = Date.now(); poll(); } }
